...
final dummyProducts = [
  ...
  Product(
    ...
    description:
        'Star Shop Women`s Small Crossbody BagThe Clutch Bag is perfect for women who want to carry essential items with them without losing style, simply beautiful.',
    price: 29.99,
    imageUrl:
  ...
  Product(
    ...
    description:
        'My Way is the perfume of discoveries and connections for an open-minded, curious and authentic woman who is ready to broaden her horizons and live meaningful encounters around the world.',
    price: 300.30,
    imageUrl:
  ...
  Product(
    ...
    title: 'Social Belt',
    description:
        'The Yes Basic Belt is made of high quality alternative material for a modern and elegant style, making your look more formal..',
    price: 21.90,
    imageUrl:
  ...
  Product(
    ...
    description:
        'Meet the Men`s Polo Vili Sneakers! Modern and unmistakable, the Polo Vili men`s sneakers are the ideal option at all times.',
    price: 99.99,
    imageUrl:
  ...
  Product(
    ...
    description:
        'Practical and fun, the adidas x Disney Mickey Mouse children`s school backpack features an exclusive print of the character and has a large compartment to organize the children`s material.',
    price: 169.99,
    imageUrl:
  ...
  Product(
    ...
    price: 689.00,
    imageUrl:
        'https://fluiartejoias.vteximg.com.br/arquivos/ids/170467-1200-1200/Relogio-Masculino-Prata-Slim-Technos-GM10YQ-1A-Fluiarte-Joias.jpg?v=637929637836230000',
  ),
];
